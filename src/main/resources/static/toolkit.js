...
(function() {
  ...
  function renderSettings() {
    ...
    $('settingsDisplayName').value = STATE.currentUser.displayName;
  }
  ...
  function init() {
    ...
    $('userAvatar').textContent = (STATE.currentUser.displayName || STATE.currentUser.username).charAt(0).toUpperCase();
    ...
    $('profileForm').onsubmit = e => {
      e.preventDefault();
      STATE.currentUser.username = $('settingsUsername').value;
      STATE.currentUser.email = $('settingsEmail').value;
      STATE.currentUser.displayName = $('settingsDisplayName').value;
      $('userName').textContent = STATE.currentUser.displayName || STATE.currentUser.username;
      $('userAvatar').textContent = (STATE.currentUser.displayName || STATE.currentUser.username).charAt(0).toUpperCase();
      saveState();
